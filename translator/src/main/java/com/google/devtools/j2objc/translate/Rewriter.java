...
public class Rewriter extends UnitTreeVisitor {
  ...
  public void endVisit(PropertyAnnotation node) {
    ...
    if (parent instanceof FieldDeclaration) {
      ...
      field.setPropertable(true);
    } else {
      AbstractTypeDeclaration field = (AbstractTypeDeclaration) parent;
      for (BodyDeclaration body : field.getBodyDeclarations()) {
